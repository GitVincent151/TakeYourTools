...
namespace TakeYourTools
{
    ...
    internal static class TYT_HarmonyPatches
    {
        private static readonly Type patchType = typeof(TYT_HarmonyPatches);
        ...
        static TYT_HarmonyPatches()
        {
            ...
            Harmony h = new Harmony("GitVincent151.TakeYourTools");
