...
namespace TakeYourTools
{
    ...
    public static class TTY_Patch_Pawn_InventoryTracker
    {
        ...
        public static class FirstUnloadableThing
        {
            ...
            {
                Log.Message($"TYT: TTY_Patch_Pawn_InventoryTracker - FirstUnloadableThing");
        ...
        public static class InventoryTrackerTickRare
        {
            ...
            {
                Log.Message($"TYT: TTY_Patch_Pawn_InventoryTracker - InventoryTrackerTickRare");
                if (TYT_ToolsSettings.toolLimit)
                {
                    ...
                    {
                        Log.Message($"TYT: TTY_Patch_Pawn_InventoryTracker - GetHeldTools");
        ...
        public static class Notify_ItemRemoved
        {
            ...
            {
                Log.Message($"TYT: TTY_Patch_Pawn_InventoryTracker - Notify_ItemRemoved");
